    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        function crearCuenta($con, $nombres, $apePat, $apeMat, $correo, $contrasena, $celular, $sexo, $sede) {
            ...
            $sql = "INSERT INTO estudiante 
                (id_sexo, id_sede, id_tipo_usuario, nom_estudiante, ape_pat_estudiante, ape_mat_estudiante, 
                fch_reg_estudiante, est_estudiante, ema_estudiante, pas_estudiante, cel_estudiante, cod_estudiante) 
                VALUES (?, ?, 1, ?, ?, ?, NOW(), 1, ?, ?, ?, ?)";
            ...
            $stmt->bind_param("iisssssss", $sexo, $sede, $nombres, $apePat, $apeMat, $correo, $passwordHash, $celular, $codigo);
